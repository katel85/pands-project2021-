...
sns.distplot(versicolor["sepal_length"],bins=25, kde=False,color= 'b', label='Versicolor')
sns.distplot(virginica["sepal_length"])
sns.distplot(virginica["sepal_length"],bins=25, kde=False,color= 'aqua', label='Virginica')
plt.legend()
